...
@section('content')
    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>Amélioration de la performance opérationnelle</h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row" id="tabs">
          <div class="col-md-4">
            ...
            <li><a href='#tabs-4'>Réduction de coûts <i class="fa fa-angle-right"></i></a></li>
              ...
              <li><a href='#tabs-5'>Gestion financière et de la trésorerie <i class="fa fa-angle-right"></i></a></li>
            </ul>
          </div>
          <div class="col-md-8">
            <section class='tabs-content'>
              ...
              <article id='tabs-3'>
                <img src="assets/images/single_service_03.jpg" style="height: 150px;width: 800px;" alt="">
